    ...
    subtasks: [
      {
        TaskID: 19,
        TaskName:
          'Beginning of stem elongation: pseudostem and tillers erect, first internode begins to elongate,' +
...
export let baselineData: Object[] = [
  {
    ...
    BaselineEndDate: new Date('03/05/2018 11:00:00 AM'),
    StartDate: new Date('03/05/2018 08:00:00 AM'),
